...
//	kprintf("Initializing thread 2\n");
	...
	task2.kstack[4064] = 0; //r12
	task2.kstack[4065] = 0; //r11
	task2.kstack[4066] = 0; //r10
	task2.kstack[4067] = 0; //r9
	task2.kstack[4068] = 0; //r8
	task2.kstack[4069] = 0; //rsi
	task2.kstack[4070] = 0; //rdi
	task2.kstack[4071] = 0; //rdx
	task2.kstack[4072] = 0; //rcx
	task2.kstack[4073] = 0; //rbx
	task2.kstack[4074] = 0; //rax
	task2.kstack[4075] = 0; //eflag
	task2.kstack[4076] = (uint64_t) &test3;
